...
<div class="container-fluid" style="padding: 30px;">
    <form action="{{ route('insbupati.store') }}" method="POST" enctype="multipart/form-data" novalidate>
        @csrf

        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 25px;">
            <div>
                <h2 style="font-weight: 700; color: #1e293b; margin: 0;">Tambah Instruksi Bupati</h2>
        ...
        <div style="display: grid; grid-template-columns: 2fr 1fr; gap: 25px; align-items: start;">
            ...
            <div style="background: white; border-radius: 20px; padding: 25px; border: 1px solid #f1f5f9; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05);">
                ...
                <div style="margin-bottom: 20px;">
                    <label style="display:block; margin-bottom:8px; font-weight:600; color:#475569;">Nomor Instruksi <span class="req">*</span></label>
                    <input type="text" name="nomor" value="{{ old('nomor') }}"
                        ...
                        placeholder="Contoh: 001/INS-BUP/2024">
                    @error('nomor') <div class="err-box"><i class="fa-solid fa-circle-exclamation"></i><span>{{ $message }}</span></div> @enderror
                </div>

                <div style="margin-bottom: 20px;">
                    <label style="display:block; margin-bottom:8px; font-weight:600; color:#475569;">Judul Instruksi <span class="req">*</span></label>
                    <input type="text" name="judul" value="{{ old('judul') }}"
                        class="{{ $errors->has('judul') ? 'is-err' : '' }}"
                        style="width:100%; padding:12px; border:1px solid #e2e8f0; border-radius:10px; box-sizing:border-box;"
                        placeholder="Masukkan judul instruksi bupati...">
