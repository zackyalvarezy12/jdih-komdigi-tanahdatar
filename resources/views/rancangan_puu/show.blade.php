...
@section('breadcrumb')
<li class="breadcrumb-item"><a href="#"><i class="bi bi-file-earmark-diff"></i> Dokumen Hukum</a></li>
...
<div class="detail-card">
    <div class="detail-header">
        <div class="detail-badge"><i class="bi bi-file-earmark-diff"></i> Rancangan PUU</div>
