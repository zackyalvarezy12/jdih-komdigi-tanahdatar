...
@section('breadcrumb')
<li class="breadcrumb-item"><a href="#"><i class="bi bi-file-earmark-check"></i> Regulasi</a></li>
...
<div class="detail-card">
    <div class="detail-header">
        <div class="detail-badge"><i class="bi bi-file-earmark-check"></i> Peraturan Bupati</div>
        <h1 class="detail-title">{{ $item->judul }}</h1>
    </div>
    <div class="detail-body">
        <div class="meta-grid">
            <div class="meta-item"><div class="lbl">Nomor</div><div class="val">{{ $item->nomor ?: '-' }}</div></div>
            <div class="meta-item"><div class="lbl">Tahun</div><div class="val">{{ $item->tahun ?: '-' }}</div></div>
            <div class="meta-item"><div class="lbl">Tanggal</div><div class="val">{{ $item->tanggal ?: '-' }}</div></div>
            <div class="meta-item"><div class="lbl">Tempat Penetapan</div><div class="val">{{ $item->tempat_penetapan ?: '-' }}</div></div>
            <div class="meta-item"><div class="lbl">Sumber</div><div class="val">{{ $item->sumber ?: '-' }}</div></div>
            <div class="meta-item"><div class="lbl">Bidang Hukum</div><div class="val">{{ $item->bidang_hukum ?: '-' }}</div></div>
            <div class="meta-item"><div class="lbl">Bahasa</div><div class="val">{{ $item->bahasa ?: '-' }}</div></div>
            <div class="meta-item"><div class="lbl">Subjek</div><div class="val">{{ $item->subjek ?: '-' }}</div></div>
        </div>

        @if($item->keterangan)
        <div class="mb-4">
            <div class="section-label">Keterangan</div>
            <div class="content-text">{!! $item->keterangan !!}</div>
        </div>
        @endif
