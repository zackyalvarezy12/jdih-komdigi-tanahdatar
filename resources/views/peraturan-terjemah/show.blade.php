...
@section('breadcrumb')
<li class="breadcrumb-item"><a href="#"><i class="bi bi-translate"></i> Regulasi</a></li>
...
<div class="detail-card">
    <div class="detail-header">
        <div class="detail-badge"><i class="bi bi-translate"></i> Peraturan Terjemah</div>
    ...
    <div class="detail-body">
        <div class="meta-grid">
            ...
            <div class="meta-item">
                ...
                <div class="val">{{ $item->bahasa ?: '-' }}</div>
            </div>
            <div class="meta-item">
                <div class="lbl">Subjek</div>
                <div class="val">{{ $item->subjek ?: '-' }}</div>
            </div>
            <div class="meta-item">
                <div class="lbl">Sumber</div>
                <div class="val">{{ $item->sumber ?: '-' }}</div>
            </div>
        </div>
